...
public class Main {
	public static void main(String[] args) {
		...
		/*
		 * System.out.print("Enter the pattern (CSMA/CD or CSMA/CA)"); patern =
		 * scan.next();
		 */
		...
		/*
		 * } else if (patern.equals("CSMA/CA")){ CSMA_CA[] virtualHosts = new
		 * CSMA_CA[nbClients]; for (int i = 0; i < nbClients; i++){ virtualHosts[i] =
		 * new CSMA_CA("[HOST:" + i + "]", nbPackets); }
		 * 
		 * for (int j = 0; j < nbClients; j++){ virtualHosts[j].start(); } }
		 */
	}
}